...
class ReportAgent:
    ...
    def run(
        ...
        summary = {
            ...
            "strategy": strategy,
            "curve_snapshot": {
                "yield_3m": float(current["yield_3m"]),
                "yield_6m": float(current["yield_6m"]),
                "yield_1y": float(current["yield_1y"]),
                "yield_2y": float(current["yield_2y"]),
                "yield_3y": float(current["yield_3y"]),
                "yield_5y": float(current["yield_5y"]),
                "yield_7y": float(current["yield_7y"]),
                "yield_10y": float(current["yield_10y"]),
                "yield_20y": float(current["yield_20y"]),
                "yield_30y": float(current["yield_30y"]),
                ...
                "breakeven_5y": float(current["breakeven_5y"]),
                "breakeven_10y": float(current["breakeven_10y"]),
                "real_5y": float(current["real_5y"]),
                "real_10y": float(current["real_10y"]),
                "sofr": float(current["sofr"]),
                "fed_funds_effective": float(current["fed_funds_effective"]),
                "overnight_bank_funding_rate": float(current["overnight_bank_funding_rate"]),
                "sofr_minus_ff": float(current["sofr_minus_ff"]),
                "repo_minus_sofr": float(current["repo_minus_sofr"]),
            ...
            "daily_changes": {
                "yield_3m_bp": float((current["yield_3m"] - previous["yield_3m"]) * 100.0),
                "yield_2y_bp": float((current["yield_2y"] - previous["yield_2y"]) * 100.0),
                "yield_5y_bp": float((current["yield_5y"] - previous["yield_5y"]) * 100.0),
                "yield_10y_bp": float((current["yield_10y"] - previous["yield_10y"]) * 100.0),
                "yield_30y_bp": float((current["yield_30y"] - previous["yield_30y"]) * 100.0),
                "curve_2s10s_bp": float((current["curve_2s10s"] - previous["curve_2s10s"]) * 100.0),
                "curve_5s30s_bp": float((current["curve_5s30s"] - previous["curve_5s30s"]) * 100.0),
                "breakeven_5y_bp": float((current["breakeven_5y"] - previous["breakeven_5y"]) * 100.0),
                ...
                "sofr_bp": float((current["sofr"] - previous["sofr"]) * 100.0),
                "sofr_minus_ff_bp": float((current["sofr_minus_ff"] - previous["sofr_minus_ff"]) * 100.0),
                "repo_minus_sofr_bp": float((current["repo_minus_sofr"] - previous["repo_minus_sofr"]) * 100.0),
